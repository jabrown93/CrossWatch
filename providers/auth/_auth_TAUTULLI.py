          ...
          <div class="cw-subpanel active" data-sub="auth">
            ...
            <div class="grid2">
              <div>
                ...
                <input id="tautulli_server" data-cfg-path="tautulli.server_url" data-cfg-instance-root="tautulli" name="tautulli_server" type="text" placeholder="http://localhost:8181" autocomplete="off" spellcheck="false" autocapitalize="off" />
              </div>
              <div>
                <label for="tautulli_key">API Key</label>
                <input id="tautulli_key" data-cfg-path="tautulli.api_key" data-cfg-instance-root="tautulli" name="tautulli_key" type="password" placeholder="********" autocomplete="off" spellcheck="false" autocapitalize="off" data-lpignore="true" data-1p-ignore="true" data-bwignore="true" />
              </div>
            </div>
            ...
            <div style="margin-top:10px;max-width:240px">
              ...
              <input id="tautulli_user_id" data-cfg-path="tautulli.history.user_id" data-cfg-instance-root="tautulli" name="tautulli_user_id" type="text" placeholder="1" autocomplete="off" spellcheck="false" autocapitalize="off" />
            </div>
