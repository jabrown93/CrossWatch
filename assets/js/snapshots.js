...
function bundleKey(s) {
  ...
  function render() {
    ...
    if (browserCard) {
      ...
      if (hint) hint.innerHTML = `<span class="material-symbol">compare_arrows</span><div>Two checked captures must share the same provider and feature before compare is enabled.</div>`;
