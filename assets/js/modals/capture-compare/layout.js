...
<div class="cc-toolbar"><input id="cc-search" type="search" autocomplete="off" placeholder="Search title, ids, key..."><select id="cc-feature" title="Feature" autocomplete="off"><option value="">Feature</option></select><div class="cc-chip add on" data-st="added">Added</div><div class="cc-chip del on" data-st="removed">Deleted</div><div class="cc-chip on" data-st="updated">Updated</div><div class="cc-chip unc" data-st="unchanged">Unchanged</div><select id="cc-type" autocomplete="off"><option value="">All types</option><option value="movie">Movies</option><option value="show">Shows</option><option value="season">Seasons</option><option value="episode">Episodes</option></select><select id="cc-sort" autocomplete="off"><option value="status">Sort: status</option><option value="title">Sort: title</option><option value="key">Sort: key</option></select><div class="cc-chip on" id="cc-changed">Changed only</div></div>
...
.cc-modal .cx-head,
.cc-modal .cc-toolbar,
.cc-modal .cc-pane-head,
.cc-modal .cc-detail-head,
.cc-modal .cc-pane-foot,
.cc-modal .cc-bottom,
.cc-modal .cc-changes{
...
.cc-modal .cc-pane,
.cc-modal .cc-bottom-wrap,
.cc-modal .cc-pane-list,
.cc-modal .cc-detail-split,
.cc-modal .cc-rec{
  background:var(--cc-bg)!important;
}
.cc-modal .cc-title,
.cc-modal .cc-mark .material-symbols-rounded,
.cc-modal .cc-pane-head .t,
.cc-modal .cc-detail-head .tt,
.cc-modal .cc-title2,
.cc-modal .cc-rec .card .ttl .name,
.cc-modal .kv .v,
.cc-modal .chg .p,
.cc-modal .chg .v{
  color:var(--cc-text)!important;
...
.cc-modal .cc-sub,
.cc-modal .cc-mini,
.cc-modal .cc-foot-mini,
.cc-modal .kv .k,
.cc-modal .empty,
.cc-modal .cc-pane-head .s,
.cc-modal .cc-detail-head .k,
.cc-modal .cc-rec .card .ttl .mini,
.cc-modal .chg .lab{
  color:var(--cc-muted)!important;
}
.cc-modal input[type=search],
.cc-modal select{
...
.cc-modal .chip,
.cc-modal .cc-chip,
.cc-modal .cc-pane-head .tag,
.cc-modal details,
.cc-modal .chg,
.cc-modal .cc-rec .card{
...
.cc-modal .cc-row:hover{
  background:var(--cc-panel)!important;
}
.cc-modal .cc-row.sel{
  background:color-mix(in srgb,var(--cc-accent) 14%,var(--cc-panel))!important;
  box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--cc-accent) 48%,transparent)!important;
}
.cc-modal pre{
  background:var(--cc-input)!important;
  border-color:var(--cc-border)!important;
...
.cc-modal .cc-mark{
  background:color-mix(in srgb,var(--cc-good) 18%,var(--cc-panel-2))!important;
  border-color:color-mix(in srgb,var(--cc-good) 34%,var(--cc-border))!important;
  box-shadow:none!important;
}
.cc-modal .cc-hsplit::after,
.cc-modal .cc-vsplit::after{
  background:color-mix(in srgb,var(--cc-accent) 72%,transparent)!important;
}
.cc-modal .wait-overlay{
  background:color-mix(in srgb,var(--cc-bg) 82%,transparent)!important;
}
.cc-modal .wait-card{
  background:var(--cc-panel)!important;
  border-color:var(--cc-border)!important;
...
html[data-cw-theme="flat-light"] .cx-modal-shell.cc-modal{
  color-scheme:light!important;
}
html[data-cw-theme="flat-light"] .cc-modal input[type=search],
html[data-cw-theme="flat-light"] .cc-modal select{
  color-scheme:light!important;
}
html[data-cw-theme="flat-light"] .cc-modal .cc-chip.on,
html[data-cw-theme="flat-light"] .cc-modal .cc-st.upd,
html[data-cw-theme="flat-light"] .cc-modal .stat-pill.show{
  border-color:rgba(70,86,166,.38)!important;
  background:#e9ecf7!important;
}
html[data-cw-theme="flat-light"] .cc-modal .cc-chip.add.on,
html[data-cw-theme="flat-light"] .cc-modal .cc-st.add,
html[data-cw-theme="flat-light"] .cc-modal .stat-pill.movie{
  border-color:rgba(8,145,178,.34)!important;
  background:#e6f6fb!important;
}
html[data-cw-theme="flat-light"] .cc-modal .cc-chip.del.on,
html[data-cw-theme="flat-light"] .cc-modal .cc-st.del,
html[data-cw-theme="flat-light"] .cc-modal .stat-pill.episode{
  border-color:rgba(169,63,77,.34)!important;
  background:#fbecef!important;
}
html[data-cw-theme="flat-light"] .cc-modal .cc-chip.unc.on,
html[data-cw-theme="flat-light"] .cc-modal .cc-st.unc,
html[data-cw-theme="flat-light"] .cc-modal .stat-pill.season{
