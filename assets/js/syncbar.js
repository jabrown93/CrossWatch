...
#ux-progress{margin-top:12px;position:relative;z-index:1;padding:12px 14px 10px;border-radius:18px;background:radial-gradient(120% 160% at 0% 0%,rgba(88,64,190,.11) 0%,rgba(88,64,190,0) 36%),radial-gradient(110% 150% at 100% 0%,rgba(0,132,182,.08) 0%,rgba(0,132,182,0) 34%),linear-gradient(180deg,rgba(13,18,28,.92),rgba(7,11,18,.88));border:1px solid rgba(255,255,255,.08);box-shadow:inset 0 1px 0 rgba(255,255,255,.035),0 14px 30px rgba(0,0,0,.26);backdrop-filter:blur(14px) saturate(110%);-webkit-backdrop-filter:blur(14px) saturate(110%)}
...
.sb-node{display:inline-flex;align-items:center;gap:7px;min-width:0;height:28px;padding:0 10px;border-radius:999px;border:1px solid rgba(255,255,255,.08);background:rgba(8,12,20,.58);box-shadow:inset 0 1px 0 rgba(255,255,255,.035);backdrop-filter:blur(10px) saturate(110%);-webkit-backdrop-filter:blur(10px) saturate(110%)}
...
.sb-node-logo-text{display:inline-flex;align-items:center;justify-content:center;min-width:18px;height:18px;padding:0 5px;border-radius:999px;background:rgba(255,255,255,.06);font-size:9px;font-weight:800;letter-spacing:.04em;color:rgba(242,247,255,.9)}
...
.sb-feat{display:inline-flex;align-items:center;justify-content:center;height:22px;max-width:110px;padding:0 8px;border-radius:999px;border:1px solid rgba(255,255,255,.07);background:rgba(255,255,255,.03);font-size:10px;font-weight:800;letter-spacing:.04em;text-transform:uppercase;color:rgba(196,208,228,.82);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.sb-badge{display:inline-flex;align-items:center;justify-content:center;min-width:74px;height:26px;padding:0 10px;border-radius:999px;border:1px solid rgba(255,255,255,.08);background:rgba(255,255,255,.03);box-shadow:inset 0 1px 0 rgba(255,255,255,.025);font-size:11px;font-weight:800;letter-spacing:.04em;text-transform:uppercase;color:rgba(235,241,252,.88)}
.sb-badge.running{background:linear-gradient(180deg,rgba(86,117,255,.18),rgba(41,55,111,.18));color:#edf4ff}
.sb-badge.done{background:linear-gradient(180deg,rgba(62,194,155,.18),rgba(21,99,79,.22));color:#e9fff8}
.sb-badge.error{background:linear-gradient(180deg,rgba(255,101,101,.2),rgba(105,32,32,.24));color:#fff0f0}
.sb-rail{position:relative;height:12px;border-radius:999px;overflow:visible;background:linear-gradient(180deg,rgba(7,10,16,.96),rgba(14,19,28,.94));border:1px solid rgba(255,255,255,.05);box-shadow:inset 0 1px 0 rgba(255,255,255,.02),inset 0 -8px 14px rgba(0,0,0,.34)}
...
.sb-fill{position:absolute;inset:1px auto 1px 1px;width:0%;height:calc(100% - 2px);border-radius:inherit;background:linear-gradient(90deg,#6f63ff 0%,#58a6ff 48%,#3ce0f5 100%);box-shadow:inset 0 0 14px rgba(160,193,255,.18),0 0 18px rgba(83,134,255,.18);transition:width .28s ease,filter .22s ease,opacity .22s ease;z-index:1;overflow:hidden}
...
#ux-progress .sb-steps span{display:flex;align-items:center;justify-content:center;height:28px;padding:0 8px;border-radius:999px;white-space:nowrap;font-size:10px;font-weight:700;letter-spacing:.03em;text-transform:uppercase;position:relative;isolation:isolate;color:rgba(176,188,206,.82);border:1px solid rgba(255,255,255,.06);background:rgba(255,255,255,.022);box-shadow:inset 0 1px 0 rgba(255,255,255,.018);opacity:1;transition:color .2s ease,border-color .2s ease,background .2s ease,box-shadow .2s ease,transform .2s ease,filter .2s ease}
...
#ux-progress .sb-steps span.current{color:rgba(249,251,255,.98)!important;border-color:rgba(102,153,255,.38)!important;background:linear-gradient(180deg,rgba(51,75,141,.3),rgba(27,37,63,.38))!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.06),0 0 0 1px rgba(87,126,235,.08)!important;transform:none;filter:none}
#ux-progress .sb-steps span.current::after{content:"";position:absolute;left:10px;top:50%;width:6px;height:6px;border-radius:999px;transform:translateY(-50%);background:rgba(184,200,255,.88);box-shadow:none}
#ux-progress .sb-steps span.done{color:rgba(234,241,255,.94)!important;border-color:rgba(255,255,255,.09)!important;background:linear-gradient(180deg,rgba(255,255,255,.08),rgba(255,255,255,.03))!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.045)}
