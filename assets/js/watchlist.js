...
const heroCss=`#page-watchlist .wl-hero-summary{align-self:end;justify-self:end;display:inline-flex;align-items:stretch;min-height:58px;border-radius:14px;border:1px solid rgba(218,227,245,.13);background:rgba(29,35,54,.84);box-shadow:none;overflow:hidden;position:relative;z-index:1;isolation:isolate}#page-watchlist .wl-hero-summary:before{content:"";position:absolute;inset:0;z-index:0;pointer-events:none;background:linear-gradient(180deg,rgba(40,47,74,.94),rgba(31,37,56,.92))}#page-watchlist .wl-hero-summary>*{position:relative;z-index:1}#page-watchlist .wl-hero-seg{display:grid;place-items:center;align-content:center;gap:4px;min-width:110px;padding:9px 16px;border-left:1px solid rgba(218,227,245,.13);background:transparent;color:var(--wl-fg-soft);font-size:12px;font-weight:780;line-height:1.05;text-align:center;white-space:nowrap}#page-watchlist .wl-hero-seg:first-child{border-left:0}#page-watchlist .wl-hero-seg strong{display:block;color:var(--wl-fg);font-size:22px;font-weight:900;line-height:1}#page-watchlist .wl-hero-seg span{display:block;color:var(--wl-fg-soft);font-size:12px;font-weight:760;line-height:1.1}#page-watchlist .wl-hero-sync{min-width:112px}#page-watchlist .wl-hero-refresh{appearance:none!important;-webkit-appearance:none!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;width:58px;height:auto;min-height:58px;margin:0;padding:0;border:0!important;border-left:1px solid rgba(218,227,245,.13)!important;border-radius:0!important;background:transparent!important;background-color:transparent!important;background-image:none!important;box-shadow:none!important;color:#aebdff;cursor:pointer}#page-watchlist .wl-hero-refresh:hover{background:rgba(255,255,255,.055)!important;background-color:rgba(255,255,255,.055)!important;background-image:none!important;transform:none}#page-watchlist .wl-hero-refresh.loading{opacity:.68;pointer-events:none}#page-watchlist .wl-hero-refresh .material-symbol{font-size:23px;line-height:1;color:#aebdff;-webkit-text-fill-color:#aebdff;font-variation-settings:'FILL' 1,'wght' 500,'GRAD' 0,'opsz' 24;display:inline-block;will-change:transform}#page-watchlist .wl-hero-refresh.spin .material-symbol,#page-watchlist .wl-hero-refresh.loading .material-symbol,#page-watchlist .wl-hero-refresh[disabled] .material-symbol{animation:wlrot .6s linear infinite!important}html[data-cw-theme=flat-light] #page-watchlist .wl-hero-summary{background:rgba(255,255,255,.82);border-color:rgba(78,96,180,.20)}html[data-cw-theme=flat-light] #page-watchlist .wl-hero-summary:before{background:linear-gradient(180deg,rgba(255,255,255,.94),rgba(246,248,255,.90))}html[data-cw-theme=flat-light] #page-watchlist .wl-hero-seg,html[data-cw-theme=flat-light] #page-watchlist .wl-hero-refresh{border-color:rgba(78,96,180,.18)!important}html[data-cw-theme=flat-light] #page-watchlist .wl-hero-seg strong{color:#172033}html[data-cw-theme=flat-light] #page-watchlist .wl-hero-refresh{background:transparent!important;background-color:transparent!important;background-image:none!important;color:#172033}html[data-cw-theme=flat-light] #page-watchlist .wl-hero-refresh:hover{background:rgba(17,24,39,.045)!important;background-color:rgba(17,24,39,.045)!important;background-image:none!important}html[data-cw-theme=flat-light] #page-watchlist .wl-hero-refresh .material-symbol{color:#172033;-webkit-text-fill-color:#172033}@media(max-width:760px){#page-watchlist .wl-hero-summary{justify-self:start;max-width:100%;min-height:50px;flex-wrap:wrap}#page-watchlist .wl-hero-seg{min-width:88px;padding:8px 12px}#page-watchlist .wl-hero-seg strong{font-size:18px}#page-watchlist .wl-hero-refresh{width:52px;min-height:50px}}`;
  ...
  ensureStyle("watchlist-hero-styles", heroCss);
